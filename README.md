...
El programa permite realizar conversiones de divisas en tiempo real. Se conecta a la **ExchangeRate-API** para obtener los datos de las tasas de cambio actuales en formato JSON y realiza los cálculos matemáticos exactos según la moneda que elija el usuario.

## 🚀 Funcionalidades
El sistema cuenta con un menú interactivo que permite las siguientes conversiones:
